...
@Component({
    ...
    templateUrl:'./app/newrequest/newrequest.component.html',
    styleUrls:['./app/newrequest/newrequest.component.css']
})
export class NewRequestComponent implements OnInit
{
    ...
    private userResponse:string="No Response";
...
@Component({
    ...
    templateUrl: './app/newrequest/register.snack-bar-component.html',
    styles: [`
    .saverecord {
      color: hotpink;
